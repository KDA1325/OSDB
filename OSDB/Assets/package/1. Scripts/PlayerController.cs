...
public class PlayerController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Camera.main -> Scene 내의 Main Camera를 알아서 찾아옴
        // transform.parent -> 메인 카메라의 부모 지정
        // transform -> 캐릭터의 transform
        // => 캐릭터가 Main Camera의 부모가 됨(메인 카메라를 캐릭터의 자식으로 넣는 작업)
    ...
    private void OnTriggerExit2D(Collider2D collision) // 떨어진 물체를 가져옴
    {
