...
public class SPUM_Manager : MonoBehaviour
{
    ...
    public IEnumerator StartProcess()
    {
        ...
        {
            SetSpriteList(0,"0_Hair"); //?§Ïñ¥ ?∞Í≤∞
            SetSpriteList(1,"1_FaceHair"); //?òÏóº ?∞Í≤∞
            SetSpriteList(2,"4_Helmet"); //?¨Íµ¨ ?∞Í≤∞
            SetSpriteList(3,"2_Cloth"); //???∞Í≤∞
            SetSpriteList(4,"3_Pant"); //?§Ïñ¥ ?∞Í≤∞
            SetSpriteList(5,"5_Armor"); //Í∞ëÏò∑ ?∞Í≤∞
            SetSpriteList(6,"7_Back"); //???ÑÏù¥???∞Í≤∞
            SetSpriteList(7,"6_Weapons"); //?§Î•∏Ï™?Î¨¥Í∏∞ ?∞Í≤∞
            SetSpriteList(8,"6_Weapons"); //?ºÏ™Ω Î¨¥Í∏∞ ?∞Í≤∞
    ...
    public void AddPackageSprite()
    {
        ...
        if(_packageList.Count > 0)
        {
            for(var i = 0 ; i < _packageList.Count;i++)
            {
                ...
                SetSpritePackageList(0,"0_Hair",pName); //?§Ïñ¥ ?∞Í≤∞
                SetSpritePackageList(1,"1_FaceHair",pName); //?òÏóº ?∞Í≤∞
                SetSpritePackageList(2,"4_Helmet",pName); //?¨Íµ¨ ?∞Í≤∞
                SetSpritePackageList(3,"2_Cloth",pName); //???∞Í≤∞
                SetSpritePackageList(4,"3_Pant",pName); //?§Ïñ¥ ?∞Í≤∞
                SetSpritePackageList(5,"5_Armor",pName); //Í∞ëÏò∑ ?∞Í≤∞
                SetSpritePackageList(6,"7_Back",pName); //???ÑÏù¥???∞Í≤∞
                SetSpritePackageList(7,"6_Weapons",pName); //?§Î•∏Ï™?Î¨¥Í∏∞ ?∞Í≤∞
                SetSpritePackageList(8,"6_Weapons",pName); //?ºÏ™Ω Î¨¥Í∏∞ ?∞Í≤∞
            }
        }
    }
    ...
    public void LoadUnitDataName(int index)
    {
        ...
        {
            //Î≤ÑÏ†º??Ï°¥Ïû¨?òÏ? ?äÍ±∞???ÜÏúºÎ©?Resync ?§Ìñâ
            tObjST.ResyncData();
